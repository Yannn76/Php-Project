...
INNER JOIN books b ON l.no_induk = b class="no_induk"
INNER JOIN customer c ON l.id_cus = c.id_cus
WHERE id= :id');
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="ket" class="form-control" rows="3" placeholder="Masukan Keterangan" style="height : 73px;"></textarea>
                    </div>
